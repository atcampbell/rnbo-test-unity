...
public class RNBO_PluginGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "RNBO Plugin"; } }
    public override string Description    { get { return "RNBO Plugin"; } }
    public override string Vendor         { get { return "Your Company Name"; } }

    //==============================================================================
    [DllImport("RNBO Plugin")] static extern System.IntPtr getRenderCallback();

    [DllImport("RNBO Plugin")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("RNBO Plugin")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("RNBO Plugin")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("RNBO Plugin")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("RNBO Plugin")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("RNBO Plugin")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
